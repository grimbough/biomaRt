...
seqMart <- martConnect(mart = "sequence")

getSequence(species="gallus_gallus", chromosome = 1, start = 400, end = 500, mart = seqMart)

martDisconnect(seqMart)
...
snpMart <- martConnect(mart = "snp")

getSNP(mart = snpMart, chromosome = 8, start = 148350, end = 159000, species ="homo_sapiens")

martDisconnect(snpMart)
