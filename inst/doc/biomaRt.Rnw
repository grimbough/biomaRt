...
gene <- getGene( id = upregulated, array = "affy_hg_u133_plus_2", mart = mart)
...
<<>>=
go <- getGO( id = upregulated[1], array = "affy_hg_u133_plus_2", mart = mart)
go
@
...
<<>>=
omim <- getOMIM( id = "203140_at" , array = "affy_hg_u133_plus_2", mart = mart)
omim
@
...
#to.mart=useMart("ensembl",dataset="cfamiliaris_gene_ensembl")
#getHomolog(id = "1939_at",to.array = "canine", from.array = "hgu95av2",from.mart = from.mart, to.mart = to.mart )
...
<<>>=
#getFeature(OMIM="diabetes mellitus", type="refseq",mart=mart)
@
...
<<>>=
getFeature(chromosome=1,start=300000, end = 3500000, type="entrezgene",mart=mart)
@
...
#Only works with using MySQL.  The mart object should be created with mart=useMart("ensembl",mysql=TRUE) 
