...
To get the information depicted in our example we can use the function \Rfunction{bmget}, using valid attributes and filter.

<<>>=
bmget(attributes=c("external_gene_id","chr_name","band"),filter="affy_hg_u95av2",values=c("1939_at","2082_s_at","1454_at"), mart=mart)
martDisconnect(mart)
@
