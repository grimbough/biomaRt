...
If you are trying to retrieve genomic information from Ensembl or Ensembl genomes, it is recommended to read [Accessing Ensembl annotation with biomaRt](https://www.bioconductor.org/packages/release/bioc/vignettes/biomaRt/inst/doc/accessing_ensembl.html) which contains similar iformation to this document, but with a specific focus on accessing those resources.
